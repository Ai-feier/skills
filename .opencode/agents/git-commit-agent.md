...
description: "Use when user says 'commit', '/commit', '提交代码', 'git commit', or when creating git commits and pushing to remote. Only handles add + commit + push, no complex git operations."
